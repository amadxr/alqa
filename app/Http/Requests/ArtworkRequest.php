...
class ArtworkRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'data.artwork.text1' => ['required', 'min:3'],
            'data.artwork.highlightedText' => ['required', 'min:3'],
            'data.artwork.text2' => ['required', 'min:3'],
            'data.artwork.text3' => ['required', 'min:3'],
            'data.artwork.text4' => ['required', 'min:3'],
            'data.artwork.sku' => ['required', 'min:3', $skuRule],
            'data.artwork.width' => ['required', 'numeric'],
            'data.artwork.height' => ['required', 'numeric'],
